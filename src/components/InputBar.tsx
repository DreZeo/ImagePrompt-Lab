          ...
          <div className="mt-3">
              ...
              <div className="flex gap-2 flex-shrink-0 mb-0.5">
                ...
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 14l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2z" />
                  </svg>
                </button>
                <div
                  className="relative"
                ...
                >
                  ...
                  <button
                    ...
                    title={settings.apiKey ? '生成 (Enter)' : '请先配置 API'}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="sm:hidden flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => setShowPromptPresets(true)}
                  className="p-2.5 rounded-xl transition-all shadow-sm flex-shrink-0 bg-gray-200 dark:bg-white/[0.06] hover:bg-gray-300 dark:hover:bg-white/[0.1] text-gray-500 dark:text-gray-300"
                  title="提示词预设"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h10M4 18h7" />
